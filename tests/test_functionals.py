...
@pytest.mark.parametrize(
    ...
    [
        (
            np.array([[2, 2, 2], [0, 0, 0]], dtype=np.float64),
            np.array([[102, 142, 52], [100, 140, 50]], dtype=np.float64),
            np.array([100, 140, 50]),
        )
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            np.array([[2, 1, 1], [0, 0, 0]], dtype=np.float64),
            np.array([[4, 1, 1], [0, 0, 0]], dtype=np.float64),
            np.array([2, 1, 1], dtype=np.float64),
        )
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            np.array([[1, 1, 1], [0, 0, 0]], dtype=np.float64),
            np.array([[0, 1, 1], [1, 0, 0]], dtype=np.float64),
            np.array([1, 0, 0]),
        )
    ],
)
